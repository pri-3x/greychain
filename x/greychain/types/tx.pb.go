...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_59b39fea89aff4a2, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_59b39fea89aff4a2, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "greychain.greychain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "greychain.greychain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("greychain/greychain/tx.proto", fileDescriptor_59b39fea89aff4a2) }

var fileDescriptor_59b39fea89aff4a2 = []byte{
	// 318 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0x2f, 0x4a, 0xad,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xf0, 0x7d, 0x49, 0x52, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/greychain.greychain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greychain.greychain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greychain.greychain.Msg",
	...
	Metadata: "greychain/greychain/tx.proto",
}
